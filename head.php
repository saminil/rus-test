...
<!-- 상단 시작 { -->
<div id="logo_rus">
	<div class="wrap"><a href="/"><img src="<?php echo G5_THEME_URL ?>/img/ci_200626.png" alt=""></a></div>
</div>

<div id="telnum">
        <p><span class="material-icons" style="color:#ff9900;">ring_volume</span>&nbsp; 전화상담 : +82 2 6749-1160</p>
        <p><span class="material-icons" style="color:#ff9900;">forward_to_inbox</span>&nbsp; 이메일 : info@rus-test.org</p>
</div>
