...
<style>
	...
	.page_title h2{width:50%; margin:0 auto; text-align:center; font-size:1.2em; color:#666; margin-top:20px; }
     ...
     .logo_location img { display: block; margin: 0px auto; width:50%;}/* 로고, 회사안내 타이틀 하단 */
...
<div class="content_wrap">
    ...
    <div class="page_title">
		...
		<h2 class="sub_txt">국내 제조업체의 유라시아 진출을 위한 제품인증 서비스 전문인증기관, 러스테스트퍼시픽이 새로운 미래를 열어갑니다. </h2>
		<br><br>
		<p class="logo_location"><img src="../image/img_900.jpg" style="display:block;width:300px;"></p>
...
<!--------
	<div class="company_type1">
		...
		<div class="ceo_area">
			<div class="ceo_tit">RUS-TEST PACIFIC은 국내 기업의 경쟁력 향상을 위한 <span class="fc_pointer">유라시아 제품인증 서비스를 제공하는</span><br><span class="fc_pointer">국제인증기관입니다.</span>
			가 만들어 가겠습니다.고객을 먼저 생각하는기업<br>고객이 먼저 자랑하는기업 ></div>
			<div class="ceo_txt">		
				<p>
...
------>
	...
	<table class="tbla">
		<tbody>
			<tr>
				<th>주&nbsp;  &nbsp;  &nbsp; &nbsp;  &nbsp;  &nbsp; 소</th>
				<td>(08504) 서울특별시 금천구 서부샛길 606, B동 2606호</td>
			</tr>
			<tr>
				<th>전&nbsp;  &nbsp;  &nbsp; &nbsp;  &nbsp;  &nbsp; &nbsp;화</th>
				<td>02-6749-1160</td>
